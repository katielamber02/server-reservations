...
export const listings: Listing[] = [
  ...
  },
  {
    ...
    description:
      "Luxury condo suite located in the heart of the city with building pool/gym/sauna available 24/7. Buses, subway, and all other amenities are available close by. reservation comes with 1 available parking spot in building underground.",
    image:
